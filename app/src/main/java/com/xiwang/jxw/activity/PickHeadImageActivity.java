 ...
 */
public class PickHeadImageActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener,
...
//    private TranslateAnimation reverseanimation;
    ...
    private static final int RESULT_REQUEST_CODE = 29; // 裁剪
        ...
        if (Build.VERSION.SDK_INT < 11){
            ...
            animation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    rl_choose_directory.setAlpha(1 - Math.abs(value / DisplayUtil.dip2px(PickHeadImageActivity.this, 400)));
            ...
            reverseanimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    listView.setLayoutParams(params);
                    rl_choose_directory.setAlpha(1 - Math.abs(value / DisplayUtil.dip2px(PickHeadImageActivity.this, 400)));
                    if (value <= -DisplayUtil.dip2px(PickHeadImageActivity.this, 300)) {
...
//    }
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.tv_choose_image_directory) {//                window.showAsDropDown(tv_choose_image_directory);
            ...
            if (currentPicNums > 0) {
                ...
                intent.setClass(PickHeadImageActivity.this, PickBigImagesActivity.class);
    ...
    private static class MyHandler extends Handler {
        ...
        WeakReference<PickHeadImageActivity> activity = null;

        public MyHandler(PickHeadImageActivity context){
            activity = new WeakReference<PickHeadImageActivity>(context);
        }
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if(view==null || view.getTag()==null){
                view = inflater.inflate(R.layout.item_pick_head_image, null);
...
//                    AlbumBitmapCacheHelper.getInstance().releaseHalfSizeCache();
                    //ToastUtil.showToast(PickHeadImageActivity.this,getImageDirectoryModelUrlFromMapById(holder.position));
                    startPhotoZoom(getImageDirectoryModelUrlFromMapById(holder.position));
                ...
                if (getImageDirectoryModelStateFromMapById(position)) {
                    if (currentPicNums == picNums) {
                        toggleImageDirectoryModelStateFromMapById(position);
                        Toast.makeText(PickHeadImageActivity.this, String.format(getString(R.string.choose_pic_num_out_of_index), picNums), Toast.LENGTH_SHORT).show();
                        return;
                    }
                    picklist.add(getImageDirectoryModelUrlFromMapById(holder.position));
                    currentPicNums++;
...
//        finish();
     ...
     * 裁剪图片方法实现
     */
    public void startPhotoZoom(String img)
    {
        Intent intent = new Intent("com.android.camera.action.CROP");

        Uri uriImg=Uri.fromFile(new File(img));
