 ...
 *
 */
public class DeleteAutoCompleteTextView extends AutoCompleteTextView implements OnFocusChangeListener, TextWatcher {
	...
	public DeleteAutoCompleteTextView(Context context) {
		this(context, null);
	}

	public DeleteAutoCompleteTextView(Context context, AttributeSet attrs) {
		// 这里构造方法也很重要，不加这个很多属性不能再XML里面定义
		this(context, attrs, android.R.attr.editTextStyle);
	}

	public DeleteAutoCompleteTextView(Context context, AttributeSet attrs, int defStyle) {
